...
tabularise_default.anova <- function(data,
  ...) {
  tabularise_tidy.anova(data = data, ...)
}
...
infos_en.anova <- list(
  method = c(
    ...
    "Analysis of Deviance Table" = "Analysis of deviance table",
    "Type III Analysis of Variance Table with Satterthwaite's method" = "Type III analysis of variance table with Satterthwaite's method"),
  labs = c(
    term = "Term",
    "df" = "Df",
...
infos_fr.anova <- list(
  method = c(
    "Analysis of Variance Table" = "Tableau de l'analyse de la variance" ,
    "Analysis of Deviance Table" = "Tableau de l'analyse de la d\u00e9viance",
    "Type III Analysis of Variance Table with Satterthwaite's method" = "Tableau de l'analyse de la variance de type III"
  ),
  labs = c(
    "term" = "Terme",
